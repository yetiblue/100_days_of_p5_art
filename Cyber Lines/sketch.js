...
Particle.prototype.move = function(){
	  this.angle=noise(this.loc.x/noiseScale, this.loc.y/noiseScale, frameCount/noiseScale)*PI/4*noiseStrength;
...
Particle.prototype.update = function(r){
    rect(this.loc.x, this.loc.y, r, r);
};